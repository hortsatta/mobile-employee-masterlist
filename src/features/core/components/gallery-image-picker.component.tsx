...
export const GalleryImagePicker: FC<Props> = ({ quality, onSelectImage, onClose }) => {
        ...
        (hasPermission === false) && (
          <View style={styles.disabledWrapper(theme)}>
            <View style={styles.disabled}>
              <Icon name={IconName.IMAGE_SLASH} color={theme.colors.text} size={60} />
              <Text style={styles.consentText}>
                We need your consent to access your phone&apos;s gallery.
              </Text>
            </View>
          </View>
        )
